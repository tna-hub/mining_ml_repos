...
</a><p><a name="user-content-layout1"><br><br>
...
d) For RQ3, it may be interesting to assess the number of commits as another filtering criteria. Remove projects with less than x commits to keep only projects with the sufficient amount of commits.
